...
**&nbsp;&nbsp;&nbsp;** **4. System:** **&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**  **[`Exit`](#exit)**__,__ **[`Print`](#print)**__,__ **[`Input`](#input)**__,__ **[`Command_Line_Arguments`](#command-line-arguments)**__,__ **[`Open`](#open)**__,__ **[`Path, Files`](#paths)**__,__ **[`DirEntry`](#direntry)**__,__ **[`OS_Commands`](#os-commands)**__,__  **[`SHELL_Commands`](#shell-commands)**__.__  
...
-----
```python
from os import getcwd, path, listdir, scandir, isfile
...
<str>  = os.path.isfile(<path>)     # Checks if path is real file.
```
